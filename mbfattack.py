#!usr
# -*- coding: UTF-8 -*-
# mod by: Hilman Maulana XD.
# team: Bacot Broterhood
...
def banner():
    ...
    print GG+"  √=================👹👹👹👹============================√"
    print WW+"  | 👉👉Tools By Hilman XD👈👈  |"
    print GL+"  |       Bacot Broterhood Team       |"
    print WW+"  |            👹👹👹FACEBOOK: Hilman Maulana Abbady👹👹👹            |"
    print Y+"  |             🔱🔱Free Fire: Hilman_XF🔱🔱              |"
    print GL+"  |👹👹👹👉👹👹👹👹👹👈👹👹👹👹|"
    print GL+"  |        LIFE Hacker&Crackerr [ L.O.S&P ]         |"
    print GL+"  |💖💖💖💖💖💖💖💖💖💖💖💖💖|"
    print GG+"  √=============================================√"
    print GL+"  |👉👉👉HACK Facebook 2020👈👈👈|"
    print GG+"  √=============================================√"
...
def edit_wordlist():
        ...
        if ed == 'y' or ed == 'Y':
                ...
                print RR+"Pilih yg bener Anjing..."
                edit_wordlist()
...
♥♥♥♥♥♥♥♥
                ...
                \033[90;1mLife Of Hacker&Cracker\033[91;1m
              Powered by:\033[97mHilman Maulana XD.
      """
...
print ("Bacot Broterhood Team , Sistem Is Easy To Hack.")
print ("Founder By : Hilman Maulana XD.")
raw_input("\n\033[1;96m[\033[1;97mBack\033[1;96m]")
